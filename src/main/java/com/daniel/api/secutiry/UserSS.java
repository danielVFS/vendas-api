package com.daniel.api.secutiry;
...
public class UserSS implements UserDetails {
	...
	public UserSS(Integer id, String email, String password, Set<Profile> profiles) {
		...
		this.autorities = profiles.stream().map(profile -> new SimpleGrantedAuthority(profile.getDescription())).collect(Collectors.toList());
	}
